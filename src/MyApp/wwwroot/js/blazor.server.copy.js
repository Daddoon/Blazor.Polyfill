...
([function (e, t, n) {
			...
			(function (e) {
					...
					return a(this, void 0, void 0, (function () {
							...
							return s(this, (function (s) {
									...
									case 0:
										...
										c ? [4, c()] : [3, 2];
									case 1:
										(y = s.sent()) && ((a = {}).Authorization = "Bearer " + y, g = a),
										s.label = 2;
									case 2:
										return b = v(),
										m = b[0],
										w = b[1],
										g[m] = w,
										e.log(r.a.Trace, "(" + t + " transport) sending data. " + f(u, l) + "."),
										E = h(u) ? "arraybuffer" : "text",
										[4, n.post(o, {
												content: u,
												headers: i({}, g, d),
												responseType: E,
									...
									case 3:
										return S = s.sent(),
										e.log(r.a.Trace, "(" + t + " transport) request complete. Response status: " + S.statusCode + "."),
										[2]
									}
								}))
						}))
				...
				var g = function () {
					...
					return e.prototype.dispose = function () {
						...
						0 === this.subject.observers.length && this.subject.cancelCallback && this.subject.cancelCallback().catch((function (e) {}))
					},
					e
				}
				(),
			...
			v = function (e) {
				function t(t) {
					...
					if (n.logger = t, "undefined" == typeof fetch) {
						var r = require;
						n.jar = new(r("tough-cookie").CookieJar),
						n.fetchType = r("node-fetch"),
						n.fetchType = r("fetch-cookie")(n.fetchType, n.jar),
						n.abortControllerType = r("abort-controller")
					} else
						n.fetchType = fetch.bind(self), n.abortControllerType = AbortController;
					return n
				}
				return p(t, e),
					...
					return g(this, void 0, void 0, (function () {
							...
							return y(this, (function (g) {
									...
									case 0:
										...
										t = new this.abortControllerType,
										e.abortSignal && (e.abortSignal.onabort = function () {
											t.abort(),
											n = new s
										}),
										r = null,
										e.timeout && (o = e.timeout, r = setTimeout((function () {
														t.abort(),
														p.logger.log(f.a.Warning, "Timeout from HTTP request."),
														n = new a
													}), o)),
										g.label = 1;
									case 1:
									...
									case 3:
										if (l = g.sent(), n)
											throw n;
										throw this.logger.log(f.a.Warning, "Error from HTTP request. " + l + "."),
										l;
									case 4:
									...
									case 5:
										if (!c.ok)
											throw new i(c.statusText, c.status);
									...
									case 6:
										return h = g.sent(),
										[2, new u(c.status, c.statusText, h)]
									}
								}))
						}))
				},
			...
			w = function (e) {
				...
				t.prototype.send = function (e) {
					...
					return e.abortSignal && e.abortSignal.aborted ? Promise.reject(new s) : e.method ? e.url ? new Promise((function (n, r) {
							...
							o.onload = function () {
								e.abortSignal && (e.abortSignal.onabort = null),
								o.status >= 200 && o.status < 300 ? n(new u(o.status, o.statusText, o.response || o.responseText)) : r(new i(o.statusText, o.status))
							},
							o.onerror = function () {
								t.logger.log(f.a.Warning, "Error from HTTP request. " + o.status + ": " + o.statusText + "."),
								r(new i(o.statusText, o.status))
							},
							o.ontimeout = function () {
								t.logger.log(f.a.Warning, "Timeout from HTTP request."),
								r(new a)
							},
							o.send(e.content || "")
			...
			S = function (e) {
				function t(t) {
					var n = e.call(this) || this;
					if ("undefined" != typeof fetch || h.c.isNode)
						n.httpClient = new v(t);
					else {
			...
			R = function () {
				function e(e, t, n, r) {
					var o = this;
					h.a.isRequired(e, "connection"),
					h.a.isRequired(t, "logger"),
					h.a.isRequired(n, "protocol"),
					...
					this.handshakeProtocol = new _.a,
				...
				Object.defineProperty(e.prototype, "baseUrl", {
					...
					set: function (e) {
						if (this.connectionState !== I.Disconnected && this.connectionState !== I.Reconnecting)
				...
				e.prototype.startWithStateTransitions = function () {
					return k(this, void 0, void 0, (function () {
							...
							return T(this, (function (t) {
									switch (t.label) {
									case 0:
										if (this.connectionState !== I.Disconnected)
										...
										this.logger.log(f.a.Debug, "Starting HubConnection."),
										t.label = 1;
									case 1:
									...
									case 2:
										...
										this.logger.log(f.a.Debug, "HubConnection connected successfully."),
										[3, 4];
									case 3:
										return e = t.sent(),
										this.connectionState = I.Disconnected,
										this.logger.log(f.a.Debug, "HubConnection failed to start successfully because of error '" + e + "'."),
										[2, Promise.reject(e)];
									case 4:
										return [2]
									}
							...
							return T(this, (function (o) {
									...
									case 0:
										...
										e = new Promise((function (e, t) {
													r.handshakeResolver = e,
													r.handshakeRejecter = t
												})),
									...
									case 1:
										...
										o.label = 2;
									case 2:
										return o.trys.push([2, 5, , 7]),
										t = {
											protocol: this.protocol.name,
											version: this.protocol.version
										},
										this.logger.log(f.a.Debug, "Sending handshake request."),
										[4, this.sendMessage(this.handshakeProtocol.writeHandshakeRequest(t))];
									case 3:
										return o.sent(),
										this.logger.log(f.a.Information, "Using HubProtocol '" + this.protocol.name + "'."),
										this.cleanupTimeout(),
									...
									case 5:
										return n = o.sent(),
										this.logger.log(f.a.Debug, "Hub handshake failed with error '" + n + "' during start(). Stopping HubConnection."),
										this.cleanupTimeout(),
				...
				e.prototype.stream = function (e) {
					...
					return u.cancelCallback = function () {
						...
						return delete t.callbacks[c.invocationId],
						o.then((function () {
					...
					o = this.sendWithProtocol(c).catch((function (e) {
								u.error(e),
								delete t.callbacks[c.invocationId]
							})),
					this.launchStreams(a, o),
					u
				},
				...
				e.prototype.invoke = function (e) {
					...
					c = new Promise((function (e, n) {
								...
								var r = t.sendWithProtocol(s).catch((function (e) {
											n(e),
											delete t.callbacks[s.invocationId]
										}));
								t.launchStreams(i, r)
							}));
					return c
				...
				e.prototype.processHandshakeResponse = function (e) {
					...
					try {
						...
						var i = new Error(o);
						throw this.handshakeRejecter(i),
						i
					}
					if (n.error) {
					...
					return this.logger.log(f.a.Debug, "Server handshake complete."),
					...
					this.connection.features.inherentKeepAlive || (this.cleanupPingTimer(), this.pingServerHandle = setTimeout((function () {
									return k(e, void 0, void 0, (function () {
											return T(this, (function (e) {
													switch (e.label) {
													case 0:
														if (this.connectionState !== I.Connected)
															return [3, 4];
														e.label = 1;
													case 1:
				...
				e.prototype.invokeClientMethod = function (e) {
					...
					if (n) {
						...
						if (e.invocationId) {
							...
							this.logger.log(f.a.Error, r),
							this.stopPromise = this.stopInternal(new Error(r))
						}
					} else
						this.logger.log(f.a.Warning, "No client method with the name '" + e.target + "' found.")
				},
				e.prototype.connectionClosed = function (e) {
					this.logger.log(f.a.Debug, "HubConnection.connectionClosed(" + e + ") called while in state " + this.connectionState + "."),
					this.stopDuringStartError = this.stopDuringStartError || e || new Error("The underlying connection was closed before the hub handshake could complete."),
					this.handshakeResolver && this.handshakeResolver(),
					this.cancelCallbacksWithError(e || new Error("Invocation canceled due to the underlying connection being closed.")),
					this.cleanupTimeout(),
					this.cleanupPingTimer(),
					this.connectionState === I.Disconnecting ? this.completeClose(e) : this.connectionState === I.Connected && this.reconnectPolicy ? this.reconnect(e) : this.connectionState === I.Connected && this.completeClose(e)
				},
				...
				e.prototype.reconnect = function (e) {
					return k(this, void 0, void 0, (function () {
							...
							return T(this, (function (s) {
									switch (s.label) {
									case 0:
										if (t = Date.now(), n = 0, r = void 0 !== e ? e : new Error("Attempting to reconnect due to a unknown error."), null === (o = this.getNextRetryDelay(n++, 0, r)))
											return this.logger.log(f.a.Debug, "Connection not reconnecting because the IRetryPolicy returned null on the first reconnect attempt."), this.completeClose(e), [2];
										if (this.connectionState = I.Reconnecting, e ? this.logger.log(f.a.Information, "Connection reconnecting because of error '" + e + "'.") : this.logger.log(f.a.Information, "Connection reconnecting."), this.onreconnecting) {
											...
											if (this.connectionState !== I.Reconnecting)
												return this.logger.log(f.a.Debug, "Connection left the reconnecting state in onreconnecting callback. Done reconnecting."), [2]
										}
										s.label = 1;
									case 1:
									...
									case 2:
										if (s.sent(), this.reconnectDelayHandle = void 0, this.connectionState !== I.Reconnecting)
											return this.logger.log(f.a.Debug, "Connection left the reconnecting state during reconnect delay. Done reconnecting."), [2];
										s.label = 3;
									case 3:
										return s.trys.push([3, 5, , 6]),
										[4, this.startInternal()];
									case 4:
										if (s.sent(), this.connectionState = I.Connected, this.logger.log(f.a.Information, "HubConnection reconnected successfully."), this.onreconnected)
											try {
									...
									case 5:
										return i = s.sent(),
										this.logger.log(f.a.Information, "Reconnect attempt failed because of error '" + i + "'."),
										this.connectionState !== I.Reconnecting ? (this.logger.log(f.a.Debug, "Connection left the reconnecting state during reconnect attempt. Done reconnecting."), [2]) : (r = i instanceof Error ? i : new Error(i.toString()), o = this.getNextRetryDelay(n++, Date.now() - t, r), [3, 6]);
									case 6:
										return [3, 1];
									case 7:
										return this.logger.log(f.a.Information, "Reconnect retries have been exhausted after " + (Date.now() - t) + " ms and " + n + " failed attempts. Connection disconnecting."),
										this.completeClose(),
										[2]
									}
								}))
				...
				e.prototype.getNextRetryDelay = function (e, t, n) {
					try {
						...
						return this.logger.log(f.a.Error, "IRetryPolicy.nextRetryDelayInMilliseconds(" + e + ", " + t + ") threw error '" + n + "'."),
						null
					}
				},
				...
				e.prototype.connect = function (e, t) {
					return L(this, void 0, void 0, (function () {
							...
							return j(this, (function (d) {
									switch (d.label) {
									case 0:
										if (h.a.isRequired(e, "url"), h.a.isRequired(t, "transferFormat"), h.a.isIn(t, P, "transferFormat"), this.url = e, this.logger.log(f.a.Trace, "(LongPolling transport) Connecting."), t === P.Binary && "undefined" != typeof XMLHttpRequest && "string" != typeof(new XMLHttpRequest).responseType)
											throw new Error("Binary protocols over XmlHttpRequest not implementing advanced features are not supported.");
										return r = Object(h.h)(),
										o = r[0],
										a = r[1],
										s = M(((n = {})[o] = a, n), this.headers),
										c = {
										...
										t === P.Binary && (c.responseType = "arraybuffer"),
										[4, this.getAccessToken()];
									case 1:
										return u = d.sent(),
										this.updateHeaderToken(c, u),
										l = e + "&_=" + Date.now(),
										this.logger.log(f.a.Trace, "(LongPolling transport) polling: " + l + "."),
										[4, this.httpClient.get(l, c)];
									case 2:
										return 200 !== (p = d.sent()).statusCode ? (this.logger.log(f.a.Error, "(LongPolling transport) Unexpected response code: " + p.statusCode + "."), this.closeError = new i(p.statusText || "", p.statusCode), this.running = !1) : this.running = !0,
										this.receiving = this.poll(this.url, c),
										[2]
									}
								}))
						}))
					...
					return L(this, void 0, void 0, (function () {
							...
							return j(this, (function (c) {
									...
									case 3:
										...
										r = e + "&_=" + Date.now(),
										this.logger.log(f.a.Trace, "(LongPolling transport) polling: " + r + "."),
									...
									case 5:
										return s = c.sent(),
										this.running ? s instanceof a ? this.logger.log(f.a.Trace, "(LongPolling transport) Poll timed out, reissuing.") : (this.closeError = s, this.running = !1) : this.logger.log(f.a.Trace, "(LongPolling transport) Poll errored after shutdown: " + s.message),
										[3, 6];
									case 6:
										return [3, 1];
									case 7:
										return [3, 9];
									case 8:
										return this.logger.log(f.a.Trace, "(LongPolling transport) Polling complete."),
				...
				e.prototype.stop = function () {
					return L(this, void 0, void 0, (function () {
							...
							return j(this, (function (a) {
									switch (a.label) {
									case 0:
										this.logger.log(f.a.Trace, "(LongPolling transport) Stopping polling."),
										this.running = !1,
									...
									case 2:
										return a.sent(),
										this.logger.log(f.a.Trace, "(LongPolling transport) sending DELETE request to " + this.url + "."),
										e = {},
										t = Object(h.h)(),
										n = t[0],
										r = t[1],
									...
									case 3:
										return i = a.sent(),
										this.updateHeaderToken(o, i),
										[4, this.httpClient.delete(this.url, o)];
									case 4:
										return a.sent(),
										this.logger.log(f.a.Trace, "(LongPolling transport) DELETE request sent."),
										[3, 6];
									case 5:
										return this.logger.log(f.a.Trace, "(LongPolling transport) Stop finished."),
										this.raiseOnClose(),
										[7];
									case 6:
										return [2]
				...
				return e.prototype.connect = function (e, t) {
					return U(this, void 0, void 0, (function () {
							...
							return F(this, (function (o) {
									switch (o.label) {
									case 0:
										return h.a.isRequired(e, "url"),
										h.a.isRequired(t, "transferFormat"),
										h.a.isIn(t, P, "transferFormat"),
										this.logger.log(f.a.Trace, "(SSE transport) Connecting."),
										this.url = e,
									...
									case 2:
										return [2, new Promise((function (n, o) {
													...
													if (t === P.Text) {
														var a;
														if (h.c.isBrowser || h.c.isWebWorker)
														...
														try {
															a.onmessage = function (e) {
																if (r.onreceive)
																	try {
																		r.logger.log(f.a.Trace, "(SSE transport) data received. " + Object(h.g)(e.data, r.logMessageContent) + "."),
																		r.onreceive(e.data)
																	} catch (e) {
															...
															a.onopen = function () {
																r.logger.log(f.a.Information, "SSE connected to " + r.url),
																r.eventSource = a,
																i = !0,
																n()
															}
			...
			J = function () {
					...
					return q(this, void 0, void 0, (function () {
							...
							return z(this, (function (o) {
									...
									case 0:
										...
										h.a.isRequired(t, "transferFormat"),
										h.a.isIn(t, P, "transferFormat"),
										this.logger.log(f.a.Trace, "(WebSockets transport) Connecting."),
										this.accessTokenFactory ? [4, this.accessTokenFactory()] : [3, 2];
									case 1:
										(n = o.sent()) && (e += (e.indexOf("?") < 0 ? "?" : "&") + "access_token=" + encodeURIComponent(n)),
										o.label = 2;
									case 2:
										return [2, new Promise((function (n, o) {
													...
													t === P.Binary && (i.binaryType = "arraybuffer"),
													i.onopen = function (t) {
														r.logger.log(f.a.Information, "WebSocket connected to " + e + "."),
														r.webSocket = i,
														s = !0,
														n()
													},
													i.onerror = function (e) {
														var t = null;
														t = "undefined" != typeof ErrorEvent && e instanceof ErrorEvent ? e.error : new Error("There was an error with the transport."),
														o(t)
													},
													i.onmessage = function (e) {
														if (r.logger.log(f.a.Trace, "(WebSockets transport) data received. " + Object(h.g)(e.data, r.logMessageContent) + "."), r.onreceive)
															try {
																r.onreceive(e.data)
															} catch (e) {
																return void r.close(e)
				...
				e.prototype.close = function (e) {
					this.webSocket && (this.webSocket.onclose = function () {}, this.webSocket.onmessage = function () {}, this.webSocket.onerror = function () {}, this.webSocket.close(), this.webSocket = void 0),
					this.logger.log(f.a.Trace, "(WebSockets transport) socket closed."),
					this.onclose && (!this.isCloseEvent(e) || !1 !== e.wasClean && 1e3 === e.code ? e instanceof Error ? this.onclose(e) : this.onclose() : this.onclose(new Error("WebSocket closed with status code: " + e.code + " (" + e.reason + ").")))
				},
			...
			K = function () {
				function e(e, t) {
					if (void 0 === t && (t = {}), this.features = {}, this.negotiateVersion = 1, h.a.isRequired(e, "url"), this.logger = Object(h.f)(t.logger), this.baseUrl = this.resolveUrl(e), (t = t || {}).logMessageContent = void 0 !== t.logMessageContent && t.logMessageContent, "boolean" != typeof t.withCredentials && void 0 !== t.withCredentials)
					...
					h.c.isNode || "undefined" == typeof WebSocket || t.WebSocket ? h.c.isNode && !t.WebSocket && n && (t.WebSocket = n) : t.WebSocket = WebSocket,
					h.c.isNode || "undefined" == typeof EventSource || t.EventSource ? h.c.isNode && !t.EventSource && void 0 !== r && (t.EventSource = r) : t.EventSource = EventSource,
					this.httpClient = t.httpClient || new S(this.logger),
				...
				return e.prototype.start = function (e) {
					return G(this, void 0, void 0, (function () {
							...
							return V(this, (function (n) {
									...
									case 0:
										return e = e || P.Binary,
										h.a.isIn(e, P, "transferFormat"),
										this.logger.log(f.a.Debug, "Starting connection with transfer format '" + P[e] + "'."),
										"Disconnected" !== this.connectionState ? [2, Promise.reject(new Error("Cannot start an HttpConnection that is not in the 'Disconnected' state."))] : (this.connectionState = "Connecting", this.startInternalPromise = this.startInternal(e), [4, this.startInternalPromise]);
									case 1:
										return n.sent(),
										"Disconnecting" !== this.connectionState ? [3, 3] : (t = "Failed to start the HttpConnection before stop() was called.", this.logger.log(f.a.Error, t), [4, this.stopPromise]);
									case 2:
										return n.sent(),
										[2, Promise.reject(new Error(t))];
									case 3:
										if ("Connected" !== this.connectionState)
											return t = "HttpConnection.startInternal completed gracefully but didn't enter the connection into the connected state!", this.logger.log(f.a.Error, t), [2, Promise.reject(new Error(t))];
										n.label = 4;
									case 4:
				...
				e.prototype.stopInternal = function (e) {
					return G(this, void 0, void 0, (function () {
							...
							return V(this, (function (n) {
									...
									case 7:
										return t = n.sent(),
										this.logger.log(f.a.Error, "HttpConnection.transport.stop() threw error '" + t + "'."),
										this.stopConnection(),
										[3, 8];
									case 8:
										...
										[3, 10];
									case 9:
										this.logger.log(f.a.Debug, "HttpConnection.transport is undefined in HttpConnection.stop() because start() failed."),
										this.stopConnection(),
										n.label = 10;
									case 10:
										return [2]
					...
					return G(this, void 0, void 0, (function () {
							...
							return V(this, (function (s) {
									...
									case 0:
										...
										s.label = 1;
									case 1:
										return s.trys.push([1, 12, , 13]),
										this.options.skipNegotiation ? this.options.transport !== O.WebSockets ? [3, 3] : (this.transport = this.constructTransport(O.WebSockets), [4, this.startTransport(t, e)]) : [3, 5];
									case 2:
										return s.sent(),
										[3, 4];
									case 3:
									...
									case 5:
										...
										o = function () {
											...
											return V(this, (function (o) {
													...
													case 1:
														if (n = o.sent(), "Disconnecting" === i.connectionState || "Disconnected" === i.connectionState)
									...
									case 10:
										...
										s.label = 11;
									case 11:
										return this.transport instanceof B && (this.features.inherentKeepAlive = !0),
										"Connecting" === this.connectionState && (this.logger.log(f.a.Debug, "The HttpConnection connected successfully."), this.connectionState = "Connected"),
										[3, 13];
									case 12:
										return a = s.sent(),
										this.logger.log(f.a.Error, "Failed to start the connection: " + a),
										this.connectionState = "Disconnected",
					...
					return G(this, void 0, void 0, (function () {
							...
							return V(this, (function (l) {
									...
									case 0:
										...
										this.accessTokenFactory ? [4, this.accessTokenFactory()] : [3, 2];
									case 1:
										(n = l.sent()) && (t.Authorization = "Bearer " + n),
										l.label = 2;
									case 2:
										r = Object(h.h)(),
										o = r[0],
										i = r[1],
										t[o] = i,
										a = this.resolveNegotiateUrl(e),
										this.logger.log(f.a.Debug, "Sending negotiation request: " + a + "."),
										l.label = 3;
									case 3:
									...
									case 5:
										return u = l.sent(),
										this.logger.log(f.a.Error, "Failed to complete negotiation with the server: " + u),
										[2, Promise.reject(u)];
									case 6:
										return [2]
									}
				...
				e.prototype.createTransport = function (e, t, n, r) {
					return G(this, void 0, void 0, (function () {
							...
							return V(this, (function (y) {
									switch (y.label) {
									case 0:
										return o = this.createConnectUrl(e, n.connectionToken),
										this.isITransport(t) ? (this.logger.log(f.a.Debug, "Connection was provided an instance of ITransport, using that directly."), this.transport = t, [4, this.startTransport(o, r)]) : [3, 2];
									case 1:
										return y.sent(),
									...
									case 4:
										if (!this.isITransport(h))
											return [3, 12];
										if (this.transport = h, s)
											return [3, 9];
										y.label = 5;
									case 5:
										return y.trys.push([5, 7, , 8]),
									...
									case 11:
										return d = y.sent(),
										this.logger.log(f.a.Error, "Failed to start the transport '" + l.transport + "': " + d),
										s = void 0,
										i.push(l.transport + " failed: " + d),
										"Connecting" !== this.connectionState ? (g = "Failed to select transport before stop() was called.", this.logger.log(f.a.Debug, g), [2, Promise.reject(new Error(g))]) : [3, 12];
									case 12:
										return c++,
										[3, 3];
									case 13:
				...
				e.prototype.resolveTransportOrError = function (e, t, n) {
					var r = O[e.transport];
					if (null == r)
						return this.logger.log(f.a.Debug, "Skipping transport '" + e.transport + "' because it is not supported by this client."), new Error("Skipping transport '" + e.transport + "' because it is not supported by this client.");
					if (!function (e, t) {
						return !e || 0 != (t & e)
					}
						(t, r))
						return this.logger.log(f.a.Debug, "Skipping transport '" + O[r] + "' because it was disabled by the client."), new Error("'" + O[r] + "' is disabled by the client.");
					if (!(e.transferFormats.map((function (e) {
									return P[e]
								})).indexOf(n) >= 0))
						return this.logger.log(f.a.Debug, "Skipping transport '" + O[r] + "' because it does not support the requested transfer format '" + P[n] + "'."), new Error("'" + O[r] + "' does not support " + P[n] + ".");
					if (r === O.WebSockets && !this.options.WebSocket || r === O.ServerSentEvents && !this.options.EventSource)
						return this.logger.log(f.a.Debug, "Skipping transport '" + O[r] + "' because it is not supported in your environment.'"), new Error("'" + O[r] + "' is not supported in your environment.");
				...
				e.prototype.stopConnection = function (e) {
					...
					if (this.logger.log(f.a.Debug, "HttpConnection.stopConnection(" + e + ") called while in state " + this.connectionState + "."), this.transport = void 0, e = this.stopError || e, this.stopError = void 0, "Disconnected" !== this.connectionState) {
						if ("Connecting" === this.connectionState)
							throw this.logger.log(f.a.Warning, "Call to HttpConnection.stopConnection(" + e + ") was ignored because the connection is still in the connecting state."), new Error("HttpConnection.stopConnection(" + e + ") was called while the connection is still in the connecting state.");
						...
						this.logger.log(f.a.Debug, "Call to HttpConnection.stopConnection(" + e + ") was ignored because the connection is already in the disconnected state.")
				},
				e.prototype.resolveUrl = function (e) {
					if (0 === e.lastIndexOf("https://", 0) || 0 === e.lastIndexOf("http://", 0))
						return e;
					if (!h.c.isBrowser || !window.document)
						throw new Error("Cannot resolve '" + e + "'.");
					var t = window.document.createElement("a");
					return t.href = e,
					this.logger.log(f.a.Information, "Normalizing '" + e + "' to '" + t.href + "'."),
					t.href
				},
				e.prototype.resolveNegotiateUrl = function (e) {
					...
					n += "negotiate",
					-1 === (n += -1 === t ? "" : e.substring(t)).indexOf("negotiateVersion") && (n += -1 === t ? "?" : "&", n += "negotiateVersion=" + this.negotiateVersion),
					n
				},
				e
			}
			...
			var X = function () {
				function e(e) {
					...
					this.buffer = [],
					this.executing = !0,
					this.sendBufferedData = new Q,
					this.transportResult = new Q,
					this.sendLoopPromise = this.sendLoop()
				}
				return e.prototype.send = function (e) {
					return this.bufferData(e),
					this.transportResult || (this.transportResult = new Q),
				...
				e.prototype.bufferData = function (e) {
					if (this.buffer.length && typeof this.buffer[0] != typeof e)
						throw new Error("Expected data to be of type " + typeof this.buffer + " but was of type " + typeof e);
					this.buffer.push(e),
					this.sendBufferedData.resolve()
				},
							...
							return V(this, (function (o) {
									...
									case 1:
										if (o.sent(), !this.executing)
											return this.transportResult && this.transportResult.reject("Connection stopped."), [3, 6];
										this.sendBufferedData = new Q,
										t = this.transportResult,
										this.transportResult = void 0,
										n = "string" == typeof this.buffer[0] ? this.buffer.join("") : e.concatBuffers(this.buffer),
										this.buffer.length = 0,
										o.label = 2;
									case 2:
										return o.trys.push([2, 4, , 5]),
										[4, this.transport.send(n)];
									case 3:
										return o.sent(),
										t.resolve(),
										[3, 5];
			...
			var re = function () {
				...
				return e.prototype.configureLogging = function (e) {
					if (h.a.isRequired(e, "logging"), void 0 !== e.log)
						this.logger = e;
						...
						this.logger = new h.b(e);
					return this
				},
				e.prototype.withUrl = function (e, t) {
					return h.a.isRequired(e, "url"),
					h.a.isNotEmpty(e, "url"),
					this.url = e,
					this.httpConnectionOptions = te({}, this.httpConnectionOptions, "object" == typeof t ? t : {
							transport: t
						}),
					this
				},
				e.prototype.withHubProtocol = function (e) {
					return h.a.isRequired(e, "protocol"),
					this.protocol = e,
					this
				},
				e.prototype.withAutomaticReconnect = function (e) {
					...
					return e ? Array.isArray(e) ? this.reconnectPolicy = new D(e) : this.reconnectPolicy = e : this.reconnectPolicy = new D,
					this
				},
			...
			function (e) {
				...
				i[0]._cachedFunctions.set("import", (function (e) {
						return "string" == typeof e && e.startsWith("./") && (e = document.baseURI + e.substr(2)),
						import(e)
					}));
				var a,
				s = 1,
			...
			(function (e) {
				...
				function v(e, t, n, r, o) {
					...
					if ("number" == typeof t)
						return t &= 255, c.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? o ? Uint8Array.prototype.indexOf.call(e, t, n) : Uint8Array.prototype.lastIndexOf.call(e, t, n) : b(e, [t], n, r, o);
				...
				c.prototype.writeUInt32LE = function (e, t, n) {
					...
					c.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : M(this, e, t, !0),
					t + 4
				},
				c.prototype.writeUInt32BE = function (e, t, n) {
					...
					t |= 0,
					n || D(this, e, t, 4, 4294967295, 0),
					c.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : M(this, e, t, !1),
					t + 4
				},
				...
				c.prototype.writeInt32LE = function (e, t, n) {
					...
					c.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : M(this, e, t, !0),
					t + 4
				},
			...
			t.monoPlatform = {
							...
							l = function () {
								window.Module = function (e, t, n) {
									...
									if (e.bootConfig.resources.runtime.hasOwnProperty("dotnet.timezones.blat") && (g = e.loadResource("dotnet.timezones.blat", "_framework/dotnet.timezones.blat", e.bootConfig.resources.runtime["dotnet.timezones.blat"], "globalization")), e.bootConfig.icuDataMode != u.ICUDataMode.Invariant) {
										...
										C = function (e, t) {
											if (!t || e.icuDataMode === u.ICUDataMode.All)
												return "icudt.dat";
											var n = t.split("-")[0];
									...
									h.preRun.push((function () {
											i = cwrap("mono_wasm_add_assembly", null, ["string", "number", "number"]),
											MONO.loaded_files = [],
											g && function (e) {
												r(this, void 0, void 0, (function () {
														...
														return o(this, (function (r) {
																...
																case 2:
																	...
																	MONO.mono_wasm_load_data_archive(new Uint8Array(n), "/usr/share/zoneinfo/"),
												...
												r(this, void 0, void 0, (function () {
														...
														return o(this, (function (o) {
																...
																case 1:
																	...
																	[4, n.arrayBuffer()];
																case 2:
																	if (r = new(i.apply(Uint8Array, [void 0, o.sent()])), a = MONO.mono_wasm_load_bytes_into_heap(r), !MONO.mono_wasm_load_icu_data(a))
																		throw new Error("Error loading ICU asset.");
																	return removeRunDependency(t),
																	[2]
																}
															}))
													}))
											}
											(w) : MONO.mono_wasm_setenv("DOTNET_SYSTEM_GLOBALIZATION_INVARIANT", "1"),
											...
											window.Blazor._internal.getLazyAssemblies = function (n) {
												...
												return BINDING.js_to_mono_obj(Promise.all([d, c]).then((function (e) {
															return t.assemblies = e[0],
															t.pdbs = e[1],
															t.assemblies.length && (window.Blazor._internal.readLazyAssemblies = function () {
																var e = t.assemblies;
																if (!e)
									...
									h.postRun.push((function () {
											...
											e.bootConfig.icuDataMode === u.ICUDataMode.Sharded && (MONO.mono_wasm_setenv("__BLAZOR_SHARDED_ICU", "1"), e.startOptions.applicationCulture && MONO.mono_wasm_setenv("LANG", e.startOptions.applicationCulture + ".UTF-8")),
											...
											cwrap("mono_wasm_enable_on_demand_gc", null, ["number"])(0),
											cwrap("mono_wasm_load_runtime", null, ["string", "number"])("appBinDir", s.hasDebuggingEnabled() ? -1 : 0),
											MONO.mono_wasm_runtime_ready(),
											n = y("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "InvokeDotNet"),
											r = y("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "BeginInvokeDotNet"),
											o = y("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "EndInvokeJS"),
											a.DotNet.attachDispatcher({
												...
												invokeDotNetFromJS: function (e, t, r, o) {
													return m(),
													n(e || null, t, r ? r.toString() : null, o)
												}
											}),
											t()
										})),
										...
										return r(this, void 0, void 0, (function () {
												...
												return o(this, (function (o) {
														...
														case 2:
															...
															new Uint8Array(Module.HEAPU8.buffer, c, s.length).set(s),
															i(t, c, s.length),
				...
				readStringField: function (e, t, n) {
					...
					return h ? void 0 === (r = h.stringCache.get(o)) && (r = BINDING.conv_string(o), h.stringCache.set(o, r)) : r = BINDING.conv_string(o),
					r
				},
			...
			t.showErrorNotification = function () {
				return r(this, void 0, void 0, (function () {
						...
						return o(this, (function (t) {
								...
								i || (i = !0, document.querySelectorAll("#blazor-error-ui .reload").forEach((function (e) {
				...
				return e.initAsync = function (t) {
					return r(this, void 0, void 0, (function () {
							...
							return o(this, (function (o) {
									...
									case 1:
										return n = o.sent(),
										r = t || n.headers.get("Blazor-Environment") || "Production",
										[4, n.json()];
									case 2:
			...
			a.prototype.copy = function (e, t, n, r) {
				...
				if (l <= this._bufs[c[0]].length - h)
					return s ? this._bufs[c[0]].copy(e, t, h, h + l) : this._bufs[c[0]].slice(h, h + l);
			...
			p = function () {
				...
				e.prototype.updateComponent = function (e, t, n, r) {
					...
					l instanceof HTMLElement && u && u.activeElement !== l && l.focus()
				},
				...
				e.prototype.applyEdits = function (e, t, n, o, a, s) {
					for (var c, u = 0, l = o, f = e.arrayBuilderSegmentReader, h = e.editReader, p = e.frameReader, d = f.values(a), g = f.offset(a), y = g + f.count(a), v = g; v < y; v++) {
						...
						case r.EditType.removeAttribute:
							var _;
							S = h.siblingIndex(b);
							if (!((_ = i.getLogicalChild(n, l + S))instanceof HTMLElement))
						...
						case r.EditType.stepIn:
							S = h.siblingIndex(b);
							n = i.getLogicalChild(n, l + S),
							u++,
							l = 0;
							break;
						case r.EditType.stepOut:
							n = i.getLogicalParent(n),
							l = 0 === --u ? o : 0;
							break;
				...
				e.prototype.insertFrame = function (e, t, n, o, i, s, c) {
					...
					case r.FrameType.element:
						return this.insertElement(e, t, n, o, i, s, c),
						1;
					...
					case r.FrameType.elementReferenceCapture:
						if (n instanceof Element)
							return a.applyCaptureIdToElement(n, u.elementReferenceCaptureId(s)), 0;
				...
				e.prototype.insertElement = function (e, t, n, o, a, s, c) {
					for (var u = e.frameReader, l = u.elementName(s), f = "svg" === l || i.isSvgElement(n) ? document.createElementNS("http://www.w3.org/2000/svg", l) : document.createElement(l), h = i.toLogicalElement(f), p = !1, d = c + u.subtreeLength(s), g = c + 1; g < d; g++) {
						...
						if (u.frameType(v) !== r.FrameType.attribute) {
							...
							p = !0,
							this.insertFrameRange(e, t, h, 0, a, g, d);
							break
						}
						this.applyAttribute(e, t, f, v)
					}
					if (p || i.insertLogicalChild(f, n, o), f instanceof HTMLOptionElement)
				...
				e.prototype.applyAttribute = function (e, t, n, r) {
					...
					if (a) {
						...
						this.tryApplySpecialProperty(e, n, i, r) || n.setAttribute(i, o.attributeValue(r))
				},
				...
				e.prototype.tryApplyValueProperty = function (e, t, n) {
					...
					case "TEXTAREA":
						...
						return t instanceof HTMLSelectElement ? (y(t, i), t._blazorSelectValue = i) : t.value = i,
						!0;
					case "OPTION":
						return (i = n ? r.attributeValue(n) : null) || "" === i ? t.setAttribute("value", i) : t.removeAttribute("value"),
				...
				e.prototype.insertFrameRange = function (e, t, n, r, o, i, a) {
					for (var s = r, c = i; c < a; c++) {
						...
						r += this.insertFrame(e, t, n, r, o, u, c),
						c += d(e, u)
					}
					return r - s
				},
			...
			t.Virtualize = {
				init: function (e, t, n, o) {
					...
					var i = function e(t) {
						if (!t)
							return null;
						if ("visible" !== getComputedStyle(t).overflowY)
							return t;
			...
			t.InputFile = {
							...
							return o(this, (function (o) {
									...
									case 1:
										...
										[4, new Promise((function (e) {
													...
													u.width = Math.round(c.width * a),
													u.height = Math.round(c.height * a),
													null === (t = u.getContext("2d")) || void 0 === t || t.drawImage(c, 0, 0, u.width, u.height),
													u.toBlob(e, n)
												}))];
									case 2:
										return u = o.sent(),
				...
				readFileData: function (e, t, n, i) {
					return r(this, void 0, void 0, (function () {
							...
							return o(this, (function (o) {
									...
									case 1:
										return r = o.sent(),
										[2, btoa(String.fromCharCode.apply(null, new Uint8Array(r, n, i)))]
									}
								}))
						}))
				},
				readFileDataSharedMemory: function (e) {
					...
					return i.monoPlatform.toUint8Array(s).set(h, c),
					f
				}
			}
		}, function (e, t, n) {
						...
						case "server":
							return function (e, t, n) {
								...
								if (!Number.isInteger(i))
									throw new Error("Error parsing the sequence '" + i + "' for component '" + JSON.stringify(e) + "'");
								if (s) {
									var c = a(s, n);
									if (!c)
										throw new Error("Could not find an end component comment for '" + t + "'");
			...
			var c = function () {
				...
				return e.prototype.next = function () {
					...
					this.currentIndex < this.length ? (this.currentElement = this.childNodes[this.currentIndex], !0) : (this.currentElement = void 0, !1)
				},
				e
			}
			(),
			...
			(function (e) {
				...
				function l(e, n, r) {
					...
					S(n) && (w = " " + f(n)),
					0 !== a.length || I && 0 != n.length ? r < 0 ? m(n) ? e.stylize(RegExp.prototype.toString.call(n), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(n), u = I ? function (e, t, n, r, o) {
			...
			(function (t, r) {
				...
				function b(e, t) {
					...
					this.decoder = null,
					this.encoding = null,
					e.encoding && (d || (d = n(44).StringDecoder), this.decoder = new d(e.encoding), this.encoding = e.encoding)
				}
				function m(e) {
					if (i = i || n(9), !(this instanceof m))
						return new m(e);
				...
				function w(e, t, n, r, o) {
					...
					null === t ? (a.reading = !1, function (e, t) {
						...
						(e, a)) : (o || (i = function (e, t) {
							var n;
							r = t,
							u.isBuffer(r) || r instanceof l || "string" == typeof t || void 0 === t || e.objectMode || (n = new TypeError("Invalid non-string/buffer chunk"));
							var r;
							return n
						}
				...
				m.prototype.push = function (e, t) {
					...
					return r.objectMode ? n = !0 : "string" == typeof e && ((t = t || r.defaultEncoding) !== r.encoding && (e = u.from(e, t), t = ""), n = !0),
					w(this, e, t, !1, n)
				},
				...
				function S(e, t) {
					return e <= 0 || 0 === t.length && t.ended ? 0 : t.objectMode ? 1 : e != e ? t.flowing && t.length ? t.buffer.head.data.length : t.length : (e > t.highWaterMark && (t.highWaterMark = function (e) {
							return e >= 8388608 ? e = 8388608 : (e--, e |= e >>> 1, e |= e >>> 2, e |= e >>> 4, e |= e >>> 8, e |= e >>> 16, e++),
							e
						}
				...
				function _(e) {
					...
					t.needReadable = !1,
					t.emittedReadable || (p("emitReadable", t.flowing), t.emittedReadable = !0, t.sync ? o.nextTick(I, e) : I(e))
				}
				function I(e) {
					p("emit readable"),
					e.emit("readable"),
				...
				m.prototype.read = function (e) {
					...
					if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && (t.length >= t.highWaterMark || t.ended))
						return p("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? x(this) : _(this), null;
					...
					t.ended || t.reading ? p("reading or ended", o = !1) : o && (p("do read"), t.reading = !0, t.sync = !0, 0 === t.length && (t.needReadable = !0), this._read(t.highWaterMark), t.sync = !1, t.reading || (e = S(n, t))),
				...
				m.prototype.pipe = function (e, t) {
					...
					i.endEmitted ? o.nextTick(c) : n.once("end", c),
					e.on("unpipe", u);
					var f = function (e) {
						return function () {
							var t = e._readableState;
				...
				m.prototype.unpipe = function (e) {
					...
					var a = A(t.pipes, e);
					return -1 === a || (t.pipes.splice(a, 1), t.pipesCount -= 1, 1 === t.pipesCount && (t.pipes = t.pipes[0]), e.emit("unpipe", this, n)),
					this
				},
			...
			function f(e, t, n, r) {
				...
				a,
				s;
				if (u(n), void 0 === (i = e._events) ? (i = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== i.newListener && (e.emit("newListener", t, n.listener ? n.listener : n), i = e._events), a = i[t]), void 0 === a)
			...
			(function (t, r, o) {
					...
					this.onwrite = function (e) {
						!function (e, t) {
							...
							if (function (e) {
								...
								!function (e, t, n, r, o) {
									--t.pendingcb,
									n ? (i.nextTick(o, r), i.nextTick(I, e, t), e._writableState.errorEmitted = !0, e.emit("error", r)) : (o(r), e._writableState.errorEmitted = !0, e.emit("error", r), I(e, t))
								}
							(e, n, r, t, o);
							else {
								var a = S(n);
				...
				function b(e) {
					if (s = s || n(9), !(d.call(b, this) || this instanceof s))
						return new b(e);
				...
				function E(e, t) {
					...
					if (e._writev && n && n.next) {
						...
						for (; n; ) {
							...
							l = n.encoding,
							f = n.callback;
							if (m(e, t, !1, t.objectMode ? 1 : u.length, u, l, f), n = n.next, t.bufferedRequestCount--, t.writing)
								break
						}
				...
				return r(this, void 0, void 0, (function () {
						...
						return o(this, (function (h) {
								...
								case 0:
									...
									return S = !0,
									t = v.resolveOptions(e),
									n = new p.ConsoleLogger(t.logLevel),
									window.Blazor.defaultReconnectionHandler = new b.DefaultReconnectionHandler(n),
									t.reconnectionHandler = t.reconnectionHandler || window.Blazor.defaultReconnectionHandler,
									n.log(d.LogLevel.Information, "Starting up blazor server-side application."),
									i = w.discoverComponents(document, "server"),
									a = new g.CircuitDescriptor(i),
									[4, I(t, n, a)];
								case 1:
									return s = h.sent(),
									[4, a.startCircuit(s)];
			...
			function I(e, t, n) {
				return r(this, void 0, void 0, (function () {
						...
						return o(this, (function (o) {
								switch (o.label) {
								case 0:
									(r = new u.MessagePackHubProtocol).name = "blazorpack",
									i = (new c.HubConnectionBuilder).withUrl("_blazor").withHubProtocol(r),
									e.configureSignalR(i),
									f = i.build(),
									y.setEventDispatcher((function (e, t) {
									...
									f.on("JS.BeginInvokeJS", s.DotNet.jsCallDispatcher.beginInvokeJSFromDotNet),
									f.on("JS.EndInvokeDotNet", (function (e) {
											var t;
											return (t = s.DotNet.jsCallDispatcher).endInvokeDotNetFromJS.apply(t, a(s.DotNet.parseJsonWithRevivers(e)))
										})),
									p = h.RenderQueue.getOrCreate(t),
									f.on("JS.RenderBatch", (function (e, n) {
											t.log(d.LogLevel.Debug, "Received render batch with id " + e + " and " + n.byteLength + " bytes."),
											p.processBatch(e, n, f)
										})),
			...
			function C(e, t, n) {
				n.log(d.LogLevel.Error, t),
				e && e.stop()
			}
			window.Blazor.start = _,
			f.shouldAutoStart() && _()
		}, function (e, t, n) {
			"use strict";
			...
			(function (t) {
					...
					if (null !== e && "object" == typeof e || null !== t && "object" == typeof t) {
						...
						return -1 !== s && s === r.expected.indexOf(t) || (r.actual.push(e), r.expected.push(t), function (e, t, n, r) {
							...
							if (o && !i || !o && i)
								return !1;
							if (o)
								return e = c.call(e), t = c.call(t), m(e, t, n);
							var s,
							u,
							l = _(e),
							f = _(t);
				...
				function S(e, t, n, r) {
					...
					s = !e && o && !n;
					if ((!e && a.isError(o) && i && E(o, n) || s) && v(o, n, "Got unwanted exception" + r), e && o && n && !E(o, n) || !e && o)
						throw o
				}
				h.AssertionError = function (e) {
					...
					e.message ? (this.message = e.message, this.generatedMessage = !1) : (this.message = function (e) {
			...
			function c(e) {
				if (!(this instanceof c))
					return (e = e || {}).msgpack = this, new c(e);
				a.call(this, e),
				this._chunks = i()
			}
			o(a, r),
			...
			function i(e, t) {
				var n;
				return (n = r.allocUnsafe(5))[0] = 202,
				n.writeFloatBE(e, 1),
				(t || Math.abs(e - n.readFloatBE(1)) > .1) && ((n = r.allocUnsafe(9))[0] = 203, n.writeDoubleBE(e, 1)),
				n
			}
			e.exports = function (e, t, n, a) {
				function s(c, u) {
					...
					if (null === c)
						...
						(f = r.byteLength(c)) < 32 ? ((l = r.allocUnsafe(1 + f))[0] = 160 | f, f > 0 && l.write(c, 1)) : f <= 255 && !n ? ((l = r.allocUnsafe(2 + f))[0] = 217, l[1] = f, l.write(c, 2)) : f <= 65535 ? ((l = r.allocUnsafe(3 + f))[0] = 218, l.writeUInt16BE(f, 1), l.write(c, 3)) : ((l = r.allocUnsafe(5 + f))[0] = 219, l.writeUInt32BE(f, 1), l.write(c, 5));
					else if (c && (c.readUInt32LE || c instanceof Uint8Array))
						c instanceof Uint8Array && (c = r.from(c)), c.length <= 255 ? ((l = r.allocUnsafe(2))[0] = 196, l[1] = c.length) : c.length <= 65535 ? ((l = r.allocUnsafe(3))[0] = 197, l.writeUInt16BE(c.length, 1)) : ((l = r.allocUnsafe(5))[0] = 198, l.writeUInt32BE(c.length, 1)), l = o([l, c]);
					else if (Array.isArray(c))
						c.length < 16 ? (l = r.allocUnsafe(1))[0] = 144 | c.length : c.length < 65536 ? ((l = r.allocUnsafe(3))[0] = 220, l.writeUInt16BE(c.length, 1)) : ((l = r.allocUnsafe(5))[0] = 221, l.writeUInt32BE(c.length, 1)), l = c.reduce((function (e, t) {
						...
						(c);
							...
							if (c >= 0)
								if (c < 128)
									(l = r.allocUnsafe(1))[0] = c;
								else if (c < 256)
									(l = r.allocUnsafe(2))[0] = 204, l[1] = c;
								else if (c < 65536)
			...
			c = function () {
				...
				return e.getOrCreate = function (t) {
					return e.instance || (e.instance = new e(0, t)),
					this.instance
				},
					...
					return r(this, void 0, void 0, (function () {
							...
							return o(this, (function (o) {
									...
									case 3:
										...
										[2];
									case 4:
										return this.logger.log(s.LogLevel.Debug, "Waiting for batch " + this.nextBatchId + ". Batch " + e + " not processed."),
										[2];
									case 5:
										return o.trys.push([5, 7, , 8]),
										this.nextBatchId++,
									...
									case 7:
										...
										this.logger.log(s.LogLevel.Error, "There was an error applying batch " + e + "."),
			...
			t.resolveOptions = function (e) {
				var t = r(r({}, i), e);
				return e && e.reconnectionOptions && (t.reconnectionOptions = r(r({}, i.reconnectionOptions), e.reconnectionOptions)),
				t
			};
			var i = {
			...
			c = function () {
				function e(e, t, n) {
					...
					this._reconnectCallback = n || function () {
			...
			var u = function () {
				...
				e.prototype.attemptPeriodicReconnection = function (t) {
					return r(this, void 0, void 0, (function () {
							...
							return o(this, (function (o) {
									...
									case 2:
										if (o.sent(), this.isDisposed)
											return [3, 7];
										o.label = 3;
									case 3:
										return o.trys.push([3, 5, , 6]),
										[4, this.reconnectCallback()];
									case 4:
										return o.sent() || this.reconnectDisplay.rejected(),
										[2];
									case 5:
										return i = o.sent(),
										this.logger.log(s.LogLevel.Error, i),
										[3, 6];
									case 6:
										return n++,
										[3, 1];
				...
				e.MaximumFirstRetryInterval = 3e3,
				e
			}
			()
		}, function (e, t, n) {
			...
			a = function () {
				...
				e.prototype.failed = function () {
					...
					this.message.querySelector("a").addEventListener("click", (function () {
							return location.reload()
						}))
				},
			...
			var r = function () {
				...
				e.prototype.rejected = function () {
					this.removeClasses(),
					this.dialog.classList.add(e.RejectedClassName)
				},
				...
				e.MaxRetriesId = "components-reconnect-max-retries",
				e.CurrentAttemptId = "components-reconnect-current-attempt",
				e
			}
			();
			...
			u = function () {
				...
				e.prototype.writeInvocation = function (e) {
					...
					return t = e.streamIds ? n.encode([i.MessageType.Invocation, e.headers || {}, e.invocationId || null, e.target, e.arguments, e.streamIds]) : n.encode([i.MessageType.Invocation, e.headers || {}, e.invocationId || null, e.target, e.arguments]),
					a.write(t.slice())
				},
				e.prototype.writeStreamInvocation = function (e) {
					var t,
					n = o(this.messagePackOptions);
					return t = e.streamIds ? n.encode([i.MessageType.StreamInvocation, e.headers || {}, e.invocationId, e.target, e.arguments, e.streamIds]) : n.encode([i.MessageType.StreamInvocation, e.headers || {}, e.invocationId, e.target, e.arguments]),
					a.write(t.slice())
				},
